...
**
** Created: Mon Sep 12 15:30:30 2016
...
public:
    ...
    void setupUi(QWidget *Widget_p2p)
    {
        ...
        sizePolicy1.setHeightForWidth(MyVideo->sizePolicy().hasHeightForWidth());
        MyVideo->setSizePolicy(sizePolicy1);
